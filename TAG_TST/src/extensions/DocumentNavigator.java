...
/**
 * Une classe d'extensions des navigateurs de document utilisés par la librairie
 * Jaxen. Elle permet de faire le lien entre la navigation Jaxen et la librairie
 * Jericho.
 * 
...
public class DocumentNavigator extends DefaultNavigator implements
	...
	public Object getDocument(String url) {
		try {
			...
			// throw new SeleniumException(Erreurs.E025,
	...
	public Object getDocumentNode(Object contextNode) {
		if (contextNode instanceof Source) {
			...
			return ((Segment) source).getAllElements(HTMLElementName.HTML).get(
					0);
		} else {
			return contextNode;
		}
